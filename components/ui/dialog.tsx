  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-2xl border-2 border-ink bg-white text-ink shadow-card",
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-3 top-3 grid place-items-center h-9 w-9 rounded-full border-2 border-ink bg-cream hover:bg-ember-500 hover:text-white transition">
        <X className="h-4 w-4" />
